...
//         <h1
//           className="font-ethenocentric text-4xl md:text-6xl font-bold text-transparent"
//           style={{
...
//           }}
//         >
//           <h4 className="text-lg font-semibold text-gray-100 text-6xl">Introduction</h4>
//           <p className="mt-2 text-gray-100 text-2xl py-5 font-calibri">
...
//           }}
//         >
//           <h2 className="text-lg font-semibold text-gray-100 text-6xl">What we do?</h2>
...
//           }}
//         >
//           <h2 className="text-lg font-semibold text-gray-100 text-6xl">What can you expect?</h2>
//           <p className="mt-2 text-gray-100 text-2xl py-5">
//             On The Other Hand, We Denounce With Righteous Indignation And Dislike Men Who Are So
//             Beguiled And Demoralized By The Charms Of Pleasure Of The Moment, So Blinded By Desire,
//             That They Cannot Foresee The Pain And Trouble That Are Bound To Ensue; And Equal Blame
...
//         {/* First Box - Introduction */}
//         <div
//           className="relative z-10 mt-8 mx-auto p-6 shadow-lg w-full md:w-2/3 hover:shadow-[0_0_25px_10px_#0083ff] bg-black bg-opacity-80 hover:bg-opacity-60 transition-all duration-100"
//           style={{
//             border: '4px solid #8a8787',
//             borderRadius: '5%',
//             padding: '16px',
...
//         {/* Third Box - Contact Us */}
//         <div
//           className="relative z-10 mt-8 mx-auto p-6 shadow-lg w-full md:w-2/3 hover:shadow-[0_0_25px_10px_#13ff00] bg-black bg-opacity-80 hover:bg-opacity-60 transition-all duration-100"
//           style={{
//             border: '4px solid #8a8787',
//             borderRadius: '5%',
//             padding: '16px',
    ...
    <div className="relative min-h-screen bg-black flex flex-col justify-start">
      ...
      <div className="flex flex-col items-center px-4 md:px-20 mt-8">
        ...
        >
          ...
          >Introduction</h4>
          <p className="mt-2 text-gray-100  py-5 font-calibri"
          style={{
            fontSize: '150%',
          }}
          >
        ...
        >
          ...
          >What we do?</h2>
          <p className="mt-2 text-gray-100  py-5"
          style={{
            fontSize: '150%',
          }}
          >
