...
// Arrow Buttons component
const ArrowButtons = () => {
  return (
    <div className="flex space-x-2 z-10">
      {/* Left Arrow Button */}
      <button className="w-10 h-10 border border-gray-400 flex justify-center items-center rounded-md bg-white bg-opacity-80 hover:bg-gray-200 transition duration-300">
        <svg
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full flex flex-col items-center">
        {/* Arrow buttons at the top center */}
        <div className="absolute top-[-50px] right-4 z-10"> {/* Adjusted top to -10px */}
          <ArrowButtons />
        </div>
