  ...
  return (
    ...
    >
      <img
        ...
        alt="robot-image"
        className="mix-blend-whiten main-image-img transform translate-x-[65%] translate-y-[-12%] lg:mt-5 z-0 ml-[7.5rem] mb-20 lg:ml-96 md:ml-[-16rem] sm:mt-0 md:mt-0 lg:mt-0 mt-10 hidden sm:block lg:block md:block sm:h-[-70vh] md:h-[90vh] lg:h-[95vh]"
      />
