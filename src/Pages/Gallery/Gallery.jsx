  ...
  return (
    <>
      ...
      sm:row-span-1 md:row-span-1 lg:col-span-2 bg-cover col-span-2 row-span-2 sm:ml-0 md:ml-0 lg:ml-0 lg:mr-3 lg:mr-4 "
            ...
            <div className="font-spaced items text-white flex-col item4 flex justify-around sm:text-[14px] text-sm box-border lg:col-span-1 md:col-span-1 sm:col-span-1 md:row-span-2 rounded-lg md:mt-8 grid-col col-span-2 row-span-1  md:text-[14px] lg:text-[14px] sm:ml-0 md:ml-0 lg:ml-0 ml-11 mt-72 sm:mt-0 mr-6  c backdrop-blur-[5px] lg:mb-8">
      ...
      >
        <div className=" backdrop-blur-[5px]">
          ...
          >
            ...
            <div className="font-spaced text-white flex-col lg:p-0 justify-around mx-0 box1 lg:row-span-2 md:row-span-1 row-span-2 sm:row-span-1 ml-1 sm:ml-8  text-sm sm:text-[14px] sm:mt-0 mt-32 lg:mt-0 sm:mr-0 mr-20 sm:pl-5 sm:pt-5 ">
      ...
      sm:row-span-1 md:row-span-1 lg:col-span-2 bg-center bg-cover row-span-2 sm:ml-0 md:ml-0 lg:ml-0 lg:mr-3 "
            ...
            {/* Text Item (spans two rows) */}
            <div className="font-spaced items text-white flex-col item4 flex justify-around sm:text-[14px] text-sm box-border lg:col-span-1 md:col-span-1 sm:col-span-1 md:row-span-2 rounded-lg md:mt-8 grid-col col-span-2 row-span-1  md:text-[14px] lg:text-[14px] sm:ml-0 md:ml-0 lg:ml-0 ml-11 mt-60 sm:mt-0 mr-1  c backdrop-blur-[5px] lg:mb-2">
      ...
      >
        <div className=" backdrop-blur-[5px]">
          ...
          >
            ...
            <div className="font-spaced text-white flex-col lg:p-0 justify-around mx-0 box1 lg:row-span-2 md:row-span-1 row-span-2 sm:row-span-1 ml-4 sm:ml-8  text-sm sm:text-[14px] sm:mt-0 mt-28 lg:mt-0 sm:mr-0 mr-20 sm:pl-5 sm:pt-5 ">
              <p className="text-justify sm:line-clamp-none line-clamp-2">
