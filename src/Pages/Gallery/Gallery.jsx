...
function Gallery(){
  ...
  return(
    ...
    <section
  name="third1"
  className={`third1 h-[100vh] section box-border bg-black ${activeSection === "third1" ? "" : "hidden"}`}
>
  ...
  <motion.div
    ...
    transition={{ duration: 1 }}
    className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 sm:grid-rows-1 md:grid-rows-2 sm:gap-3 md:gap-5 gap-4 h-[85vh] w-[90vw] items-center mt-9 sm:w-[90vw] lg:w-[95vw]  md:w-[90vw] "
  >
    {/* First Image (spans two columns on medium and large screens) */}
    <div
      className="items item1 col-span-1 sm:h-50 sm:col-span-2 md:col-span-2 lg:col-span-2 bg-cover rounded-lg "
      style={{
  ...
  <motion.div
    ...
    transition={{ duration: 1 }}
    className="container1 h-[80vh] w-[95vw] transform translate-y-[40%] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 grid-rows-2 gap-6 text-sm lg:text-[14px]" // Changed gap to 6 for better spacing
  >
...
>
  ...
  <motion.div
    ...
    whileInView={{ opacity: 1, translateX: "0%", translateY: "14%" }}
    transition={{ duration: 1 }}
    className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 sm:grid-rows-1 md:grid-rows-2 sm:gap-3 gap-6 h-[85vh] w-[90vw] items-center mt-10 sm:w-[90vw] lg:w-[95vw]  md:w-[90vw]"
  >
    {/* First Image (spans two columns on medium and large screens) */}
    <div
      className="items item1 col-span-1  sm:col-span-2 md:col-span-2 lg:col-span-2 bg-cover rounded-lg "
      style={{
        backgroundImage: "url('https://res.cloudinary.com/dqmktpekh/image/upload/f_auto,q_auto/tkq4nkjlici6hrllk9qd')",
        height: "100%",
        width: "100%",
    ...
    {/* Text Item (spans two rows) */}
    <div className="font-spaced items text-white flex-col item4 flex justify-center text-justify box-border col-span-1 md:row-span-2 rounded-lg ">
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae corrupti
        cum recusandae ab ipsam nemo reprehenderit enim aliquam, voluptatum,
        fugiat deleniti. Minima, ipsum distinctio. Sapiente nulla aspernatur
        ...
        doloribus quidem [ROBOTRON] reiciendis, saepe voluptatem dolor eos
        dolorum...
      </p> <button className="mt-8 px-3 py-1 bg-black text-white border-2 border-transparentfont-ethenocentric rounded-md hover:bg-gray-800 hover:ring-2 hover:ring-gray-400 transition-all duration-300 ease-in-out hover:shadow-lg hover:shadow-purple-500 text-sm">
                  Know More
                </button>
    </div>
