...
export default function TecnoesisButton({setId, id}) {
  ...
  return (
    <div className="relative inline-block z-50  pl-64 ml-24  " ref={dropdownRef}>
      ...
      >
        ...
        <span className="font-spaced inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg bg-slate-950 px-7 text-xl font-medium text-white backdrop-blur-3xl gap-2 group-hover:bg-transparent text-nowrap">
          Year : {id}
        </span>
      </button>
